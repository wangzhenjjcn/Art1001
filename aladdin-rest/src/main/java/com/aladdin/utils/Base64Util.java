...
public class Base64Util {
	...
	public static String encode2string(String data) {
		byte[] bytes = TypeConvert.string2byte(data, "UTF-8");
		byte[] basebytes = encode(bytes);
		return TypeConvert.byte2string(basebytes, "UTF-8");
	}

	public static String decode2string(String data) {
		byte[] buf = decode(data);
		return TypeConvert.byte2string(buf, "UTF-8");
	}
}
